...
main = do 
    ...
    let initMainMenu = [("ButtonQuit", GUIElem (IconButton (0, -120) 100 50 butQuit False)),("Button1", GUIElem (SpecialIconButton (0, 120) 90 90 level1ico False (replaceLevel initGame level1))),("Button2", GUIElem (IconButton (-130, 120) 90 90 level1ico False (replaceLevel initGame level2))), ("Button3", GUIElem (IconButton (130, 120) 90 90 level1ico False (replaceLevel initGame level3))),("Button4", GUIElem (IconButton (70, 0) 90 90 level1ico False (replaceLevel initGame level4))),("Button5", GUIElem (IconButton (-70, 0) 90 90 level1ico False (replaceLevel initGame level5)))]
